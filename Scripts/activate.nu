...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'F:\La_Quadrature_du_Net\ajouterPad\7-ajouter-un-pad'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'F:\La_Quadrature_du_Net\ajouterPad\7-ajouter-un-pad\Scripts\deactivate.nu'
